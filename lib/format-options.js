...
function getParserDir(options) {
  ...
  if (typeof parserDir !== 'string') {
    throw new TypeError('You must provide the directory where to write or read\n     the generated lexing and parsing tools (option \'parserDir\')');
  }
...
function getClasses(options) {
  ...
  return {
    ...
    isProperlySetup: function isProperlySetup() {
      return this.Lexer && typeof this.Lexer === 'function' && this.Parser && typeof this.Parser === 'function' && (!options.listener || this.Listener && typeof this.Listener === 'function') && (!options.visitor || this.Visitor && typeof this.Visitor === 'function');
    },
    getError: function getError() {
      return this.Lexer instanceof Error && this.Lexer || this.Parser instanceof Error && this.Parser || this.Listener instanceof Error && this.Listener || this.Visitor instanceof Error && this.Visitor;
    },
