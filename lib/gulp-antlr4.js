...
function getLexer(options) {
  ...
  return require(_path2.default.join(parserDir, lexer))[lexer];
}
...
function getParser(options) {
  ...
  return require(_path2.default.join(parserDir, parser))[parser];
}
...
function getListener(options) {
  ...
  return require(_path2.default.join(listenerDir, listener))[listener];
}
